...
class CAttackEffect : public CBase_Effect
{
private:
	explicit CAttackEffect(LPDIRECT3DDEVICE9 pGraphicDev);
...
public:
	static CAttackEffect*		Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos = _vec3{ 0.f,0.f,0.f });
