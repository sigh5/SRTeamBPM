...
class CMiniMonster3 :public CGameObject
{
private:
	explicit CMiniMonster3(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CMiniMonster3();
...
public:
	static CMiniMonster3*	Create(LPDIRECT3DDEVICE9 pGraphicDev, float Posx = 0, float Posy = 0);
