...
CMiniMonster3::CMiniMonster3(LPDIRECT3DDEVICE9 pGraphicDev)
	:CGameObject(pGraphicDev)
{
}

CMiniMonster3::~CMiniMonster3()
{
}

HRESULT CMiniMonster3::Ready_Object(void)
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pAnimationCom->Ready_Animation(7, 1, 0.2f);
	m_pAttackAnimationCom->Ready_Animation(8, 0, 0.2f);
...
_int CMiniMonster3::Update_Object(const _float & fTimeDelta)
{
	if (m_bDead)
	{
...
void CMiniMonster3::LateUpdate_Object(void)
{
...
void CMiniMonster3::Render_Obejct(void)
{
...
void CMiniMonster3::Collision_Event()
{
	if (!m_bAttack)
		return;
...
void CMiniMonster3::Move_Pos(_vec3 _move)
{
	m_pTransCom->Move_Pos(&_move);
}

void CMiniMonster3::Judge_Active(const _float & fTimeDelta)
{
...
_int CMiniMonster3::CalCulate_Distacne(CTransform * pPlayerTransCom, const _float & fTimeDelta)
{
	_vec3		vPlayerPos;
...
void CMiniMonster3::Set_Pos(const _vec3 & vPos)
{
	{ m_pTransCom->Set_Pos(vPos.x, vPos.y, vPos.z); m_pTransCom->Update_Component(1.f); }
}

HRESULT CMiniMonster3::Add_Component()
{
...
CMiniMonster3 * CMiniMonster3::Create(LPDIRECT3DDEVICE9 pGraphicDev, float Posx, float Posy)
{
	CMiniMonster3 *	pInstance = new CMiniMonster3(pGraphicDev);
