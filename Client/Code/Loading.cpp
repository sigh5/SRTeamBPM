...
_uint CLoading::Loading_ForStage(void)
{
	...
	*/
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_BulletTexture", CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Monster1.png", TEX_NORMAL)), E_FAIL);
																			// C:\Users\jw925\OneDrive\바탕 화면\깃\SRTeamBPM\Client\Bin\Resource\Texture\Bullet_UI
	// ~Bullet
	...
	//FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_WeaponUI_Texture0", CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Weapon_UI/Revolver.png", TEX_NORMAL)), E_FAIL);
	//FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_WeaponUI_Texture1", CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Weapon_UI/Magnum.png", TEX_NORMAL)), E_FAIL);
