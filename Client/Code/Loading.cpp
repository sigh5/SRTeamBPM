...
_uint CLoading::Loading_ForStage(void)
{
	...
	// TestWeapon
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_DoubleRevolverTexture", CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Equipment/Equip-Weapon/Equip_Weapon2.png", TEX_NORMAL, 1)), E_FAIL);
