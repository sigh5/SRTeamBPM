...
CAttackEffect::CAttackEffect(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CAttackEffect::Ready_Object(_vec3 vPos)
{
...
_int CAttackEffect::Update_Object(const _float & fTimeDelta)
{
...
void CAttackEffect::LateUpdate_Object(void)
{
...
void CAttackEffect::Render_Obejct(void)
{
...
HRESULT CAttackEffect::Set_Effect_INFO(_int iEffcet_Owner, _int iStartAnimNum, _int iAnimMax, _float fIntervel)
{
...
HRESULT CAttackEffect::Add_Component(void)
{
...
CAttackEffect * CAttackEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CAttackEffect *	pInstance = new CAttackEffect(pGraphicDev);
