...
CMonsterMini::CMonsterMini(LPDIRECT3DDEVICE9 pGraphicDev)
	:CGameObject(pGraphicDev)
{
}

CMonsterMini::~CMonsterMini()
{
	
}


HRESULT CMonsterMini::Ready_Object()
{
...
_int CMonsterMini::Update_Object(const _float & fTimeDelta)
{
	if (m_bDead)
	{
...
void CMonsterMini::LateUpdate_Object(void)
{
...
void CMonsterMini::Render_Obejct(void)
{
...
void CMonsterMini::Collision_Event()
{
	if (!m_bAttack)
		return;
...
void CMonsterMini::Set_Pos(const _vec3 & vPos)
{
	{ m_pTransCom->Set_Pos(vPos.x, vPos.y, vPos.z); m_pTransCom->Update_Component(1.f); }
}

HRESULT CMonsterMini::Add_Component()
{
...
CMonsterMini * CMonsterMini::Create(LPDIRECT3DDEVICE9 pGraphicDev, float Posx, float Posy)
{
	CMonsterMini *	pInstance = new CMonsterMini(pGraphicDev);
