#include "stdafx.h"
#include "..\Header\SkillEffct.h"

#include "Export_Function.h"
#include "MyCamera.h"

CSkillEffct::CSkillEffct(LPDIRECT3DDEVICE9 pGraphicDev)
	: CBase_Effect(pGraphicDev)
{
}

CSkillEffct::~CSkillEffct()
{
}

HRESULT CSkillEffct::Ready_Object(_vec3 vPos)
{
...
_int CSkillEffct::Update_Object(const _float & fTimeDelta)
{
...
void CSkillEffct::LateUpdate_Object(void)
{
...
void CSkillEffct::Render_Obejct(void)
{
...
HRESULT CSkillEffct::Set_Effect_INFO(_int iEffcet_Owner, _int iStartAnimNum, _int iAnimMax, _float fIntervel)
{
...
HRESULT CSkillEffct::Add_Component(void)
{
...
CSkillEffct * CSkillEffct::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CSkillEffct *	pInstance = new CSkillEffct(pGraphicDev);
