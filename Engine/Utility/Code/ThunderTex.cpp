...
HRESULT CThunderTex::Ready_Buffer(void)
{
	...
	for (int i = 0; i < 20; i++)
	{
		...
		pVertex[Vertexnum].vPos = { (float)Uvnum - 1.f, 1.f, 0.f };
		pVertex[Vertexnum].vTexUV = { 0.f, 0.f };

		pVertex[Vertexnum + 1].vPos = { (float)Uvnum + 1.f, 1.f, 0.f };
		pVertex[Vertexnum + 1].vTexUV = { 1.f, 0.f };

		pVertex[Vertexnum + 2].vPos = { (float)Uvnum + 1.f, -1.f, 0.f };
		pVertex[Vertexnum + 2].vTexUV = { 1.f, 1.f };

		pVertex[Vertexnum + 3].vPos = { (float)Uvnum - 1.f, -1.f, 0.f };
