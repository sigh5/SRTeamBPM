...
// ID_STATIC : 한 번 만들면 그대로 사용할 컴포넌트 집단
	...
	enum MONSTER_INDEX {MONSTER_ANUBIS, MONSTER_FATBAT, MONSTER_SPIDER, MONSTER_GHUL, MONSTER_OBELISK, MONSTER_SPHINX, MONSTER_FLY_HEAD, MONSTER_EARTHSHAKER, MONSTER_FIRETRAP, MONSTER_SOLDIER, MONSTER_HARPOONGUY, MONSTER_FINALBOSS,  MONSTER_END};
