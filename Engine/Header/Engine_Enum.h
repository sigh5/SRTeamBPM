...
// ID_STATIC : 한 번 만들면 그대로 사용할 컴포넌트 집단
	...
	enum OBJ_TYPE { OBJ_CUBE, OBJ_PLAYER, OBJ_MONSTER, OBJ_TELEPORT, OBJ_ROOM,OBJ_TYPE_END};
	...
	enum CUBE_TYPE {CUBE_WALL, CUBE_OBSTACLE, CUBE_START_TELE, CUBE_END_TELE ,CUBE_END};
